...
module.exports.INTERACTION_RESPOND =   (interactID, interactToken, withResponse) => `/interactions/${interactID}/${interactToken}/callback${withResponse ? "?with_response=true" : ""}`;
