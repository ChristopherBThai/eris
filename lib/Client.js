...
class Client extends EventEmitter {
   ...
   * @arg {Boolean} [options.with_response] Returns with the message that was created
  ...
  createInteractionResponse(interactionID, interactionToken, options, file) {
    ...
    if (options.with_response) {
      withResponse = options.with_response;
      delete options.with_response;
    }
    ...
    return this.requestHandler.request("POST", Endpoints.INTERACTION_RESPOND(interactionID, interactionToken, withResponse), true, options, file, "/interactions/:id/:token/callback");
  }
